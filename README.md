...
当前版本：`0.1.0`。TOC 接口版本：`120100`。已完成正式服单人基础实机验证；多人小队、团本、战斗及设置持久化仍待实机验证。
...
2026-09-25 已在正式服实机确认：执行 `/reload` 后插件加载，独立设置窗口可打开，预览可开启和关闭，整体缩放可从 100% 调到 110% 再恢复 100%，自己的当前目标名称随选择实时更新。

此次未验证游戏内设置持久化、多人小队、团本和战斗；也未完成完整错误排查，不能据此认定所有场景均无 Lua 错误。
